...
var AdminCommonModule = (function () {
    ...
    var Init = function () {
        try {
            InitUploadImg();
            SetTwoScroll();
            if (commonSetting.roles === null || commonSetting.roles === undefined || commonSetting.roles === ''
            || commonSetting.roles.length == 0 || commonSetting.roles.indexOf('DEV') < 0) {
                Common.DisableFunction(false);
            }
            // ConnectOneSignal();
            if (commonSetting.timeLogOff) {
