...
var _msg={
	...
	'C009':{
		'content': 'Bạn có chắc chắn muốn bài viết thành bản thảo không?',
		'title': 'Confirm',
		'type': 1
	},
	'C010':{
		'content': 'Bạn có chắc chắn muốn bài viết công bố không?',
		'title': 'Confirm',
		'type': 1
	},
	'C011':{
		'content': 'Bạn có chắc chắn muốn huỷ kích hoạt slide không?',
		'title': 'Confirm',
		'type': 1
	},
	'C012':{
		'content': 'Bạn có chắc chắn muốn kích hoạt slide không?',
		'title': 'Confirm',
		'type': 1
	},
	'C013':{
		'content': 'Bạn có chắc chắn muốn huỷ kích hoạt thư viện không ?',
		'title': 'Confirm',
		'type': 1
	},
	'C014':{
		'content': 'Bạn có chắc chắn muốn kích hoạt thư viện không ?',
		'title': 'Confirm',
		'type': 1
	},
	'C015':{
		'content': 'Bạn có chắc chắn muốn kích hoạt team đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C016':{
		'content': 'Bạn có chắc chắn muốn hủy kích hoạt team đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C017':{
		'content': 'Bạn có chắc chắn muốn kích hoạt plan đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C018':{
		'content': 'Bạn có chắc chắn muốn hủy kích hoạt plan đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C019':{
		'content': 'Bạn có chắc chắn muốn kích hoạt client đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C020':{
		'content': 'Bạn có chắc chắn muốn hủy kích hoạt client đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C021':{
		'content': 'Bạn có chắc chắn muốn kích hoạt partner đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C022':{
		'content': 'Bạn có chắc chắn muốn hủy kích hoạt partner đã chọn không?',
		'title': 'Confirm',
		'type': 1
	},
	'C023':{
		'content': 'Bạn có chắc chắn muốn kích hoạt video đã chọn không ?',
		'title': 'Confirm',
		'type': 1
	},
	'C024':{
		'content': 'Bạn có chắc chắn muốn huỷ kích hoạt video đã chọn không ?',
		'title': 'Confirm',
		'type': 1
	},
	'E000':{
		'content': 'Số lượng không được phép nhỏ hơn 0',
		'title': 'Error',
		'type': 4
	},
	'E001':{
	...
	'E017':{
		'content': 'Mật khẩu phải chứa ít nhất 8 ký tự',
		'title': 'Error',
		'type': 4
	},
	'E018':{
	...
	'E047':{
		'content': 'Mã đã hết số lần sử dụng. Vui lòng sử dụng mã khác.',
		'title': 'Error',
		'type': 4
	},
	'E048':{
		'content': 'Bạn đã sử dụng mã giảm giá này',
		'title': 'Error',
		'type': 4
	},
	'E049':{
	...
	'E055':{
		'content': 'Bạn không thể mua plan này vì plan bạn đang sử dụng có giá trị tương đương hoặc lớn hơn plan này',
		'title': 'Error',
		'type': 4
	},
	'E056':{
		'content': 'Giá bán không được nhỏ hơn giá gốc',
		'title': 'Error',
		'type': 4
	},
	'E057':{
		'content': 'Bạn phải điền địa chỉ mới được tiếp tục',
		'title': 'Error',
		'type': 4
	},
	'E058':{
	...
	'E059':{
		'content': 'Số lượng trong kho không đủ để gửi hàng, chúng tôi sẽ xóa giỏ hàng của bạn, xin lỗi đã làm phiền!',
		'title': 'Error',
		'type': 4
	},
	'E060':{
	...
	'S000':{
		'content': 'Đã thêm sản phẩm vào danh sách yêu thích',
		'title': 'Success',
		'type': 2
	},
	'S001':{
	...
	'S016':{
		'content': 'Tạo tài khoản thành công, chúc bạn mua sắm vui vẻ !!!',
		'title': 'Success',
		'type': 2
	},
	'S017':{
		'content': 'Huỷ đơn đặt hàng thành công !!!',
		'title': 'Success',
		'type': 2
	},
	'S018':{
		'content': 'Đặt hàng thành công, vui lòng check mail để xem thông tin đơn hàng',
		'title': 'Success',
		'type': 2
	},
	'S019':{
	...
	'A001':{
		'content': 'Đã hiện hết tất cả thư viện',
		'title': 'Alert',
		'type': 6
	}
};
...
var MSG_NO={
	...
	/** Bạn có chắc chắn muốn bài viết thành bản thảo không? */
	CONFIRM_DRAFT_BLOG: 'C009',
	/** Bạn có chắc chắn muốn bài viết công bố không? */
	CONFIRM_PUBLISHED_BLOG: 'C010',
	/** Bạn có chắc chắn muốn huỷ kích hoạt slide không? */
	CONFIRM_UNACTIVE_SLIDE: 'C011',
	/** Bạn có chắc chắn muốn kích hoạt slide không? */
	CONFIRM_ACTIVE_SLIDE: 'C012',
	/** Bạn có chắc chắn muốn huỷ kích hoạt thư viện không ? */
	CONFIRM_UNACTIVE_GALLERY: 'C013',
	/** Bạn có chắc chắn muốn kích hoạt thư viện không ? */
	CONFIRM_ACTIVE_GALLERY: 'C014',
	/** Bạn có chắc chắn muốn kích hoạt team đã chọn không? */
	CONFIRM_ACTIVE_TEAM: 'C015',
	/** Bạn có chắc chắn muốn hủy kích hoạt team đã chọn không? */
	CONFIRM_UNACTIVE_TEAM: 'C016',
	/** Bạn có chắc chắn muốn kích hoạt plan đã chọn không? */
	CONFIRM_ACTIVE_PLAN: 'C017',
	/** Bạn có chắc chắn muốn hủy kích hoạt plan đã chọn không? */
	CONFIRM_UNACTIVE_PLAN: 'C018',
	/** Bạn có chắc chắn muốn kích hoạt client đã chọn không? */
	CONFIRM_ACTIVE_CLIENT: 'C019',
	/** Bạn có chắc chắn muốn hủy kích hoạt client đã chọn không? */
	CONFIRM_UNACTIVE_CLIENT: 'C020',
	/** Bạn có chắc chắn muốn kích hoạt partner đã chọn không? */
	CONFIRM_ACTIVE_PARTNER: 'C021',
	/** Bạn có chắc chắn muốn hủy kích hoạt partner đã chọn không? */
	CONFIRM_UNACTIVE_PARTNER: 'C022',
	/** Bạn có chắc chắn muốn kích hoạt video đã chọn không ? */
	CONFIRM_ACTIVE_VIDEO: 'C023',
	/** Bạn có chắc chắn muốn huỷ kích hoạt video đã chọn không ? */
	CONFIRM_UNACTIVE_VIDEO: 'C024',
	/** nhỏ hơn 0 */
	QUANTITY_ZERO: 'E000',
	...
	/** Bạn không thể mua plan này vì plan bạn đang sử dụng có giá trị tương đương hoặc lớn hơn plan này. */
	PLAN_HAS_LOWER_VALUE: 'E055',
	/** Giá bán không được nhỏ hơn giá gốc */
	PRICE_NOT_COST: 'E056',
	/** Bạn phải điền địa chỉ mới được tiếp tục */
	CHECK_FEE: 'E057',
	/** Số lượng không đủ */
	NOT_QTY: 'E058',
	NOT_QTY_PLUS: 'E059',
	PRODUCT_NOTFOUND: 'E060',
	...
	/** Tạo tài khoản thành công, chúc bạn mua sắm vui vẻ !!! */
	CREATE_ACCOUNT_SUCCESS: 'S016',
	/** Tạo tài khoản thành công, chúc bạn mua sắm vui vẻ !!! */
	CANCEL_ORDER_SUCCESS: 'S017',
	/** Đặt hàng thành công !!! */
	ORDER_SUCCESS: 'S018',
	/** Cập nhật số lượng thành công */
	CONFIRM_UPDATE_PRODUCT: 'S019',
