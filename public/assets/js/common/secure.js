...
var Secure = (function () {
     ...
     * algorithm.
     * @param {number} q input
     * @param {number} a input
     * @param {number} b input
     * @param {number} x input
     * @param {number} s input
     ...
     *
     * Author : QuyPN - 2018/08/29 - create
     * @param {string} input Chuỗi cần mã hóa
     * @return {string} Chuỗi sau khi đã mã hóa
     */
    var EncodeBase64 = function (input) {
        ...
        var numberPaddingChars = output.length - endPos;
    ...
    var DecodeBase64 = function (input) {
        ...
        var i = 0;
        var numberPading = NumberModule.ToNumber(input.substring(input.length - 1));
