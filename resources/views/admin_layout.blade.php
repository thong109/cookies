                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        @if (Session::get('role_id') == 1)
                            ...
                            <li class="sub-menu">
                                <a href="{{ URL::to('/list-coupon') }}"> <i class="fa fa-book"></i>Quản lý mã giảm
                                    giá</a>
                            </li>
                            <li class="sub-menu">
                            ...
                            <li class="sub-menu">
                                <a href="{{ URL::to('/online') }}"><i class="fa fa-book"></i>Thanh toán Online</a>
                            </li>
                            <li class="sub-menu">
                                <a href="{{ URL::to('all-staff') }}"><i class="fa fa-book"></i>Người dùng</a>
                            </li>
                        @endif
                        <!--  -->
                        <li class="sub-menu">
                        ...
                        <li class="sub-menu">
                            <a href="{{ URL::to('/customer-list') }}"><i class="fa fa-book"></i>Danh sách khách
                                hàng</a>
                        </li>
