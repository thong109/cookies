...
<head>
    ...
    {!! Html::style('public/assets/frontend/main.d810cf0ae7f39f28f336.css') !!}
    @yield('css')
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        ...
        <div class="ui-theme-settings">
            <button type="button" id="TooltipDemo" class="btn-open-options btn btn-warning setting-icon">
    ...
    {{-- {!! Html::script('public/assets/js/common/OneSignalSDK.js') !!} --}}
    {!! Html::script('public/assets/jquery/js/jquery-3.2.1.min.js') !!}
    {!! Html::script('public/assets/ckeditor/ckeditor.js') !!}
    {!! Html::script('public/assets/js/common/admin/popper.min.js') !!}
    {{-- {!! Html::script('public/assets/bo/commonotstrap-3.3.7/js/bootstrap.js') !!} --}}
    {{-- {!! Html::script('public/assets/js/common/admin/jquery.slimscroll.min.js') !!} --}}
    {!! Html::script('public/assets/js/common/admin/select2.min.js') !!}
    {!! Html::script('public/assets/js/common/admin/raphael.min.js') !!}
    {{-- {!! Html::script('public/assets/pa/commongination/js/pagination.js') !!} --}}
    {!! Html::script('public/assets/js/common/admin/jquery-form.js') !!}
    {!! Html::script('public/assets/js/common/admin/jquery-cookie.js') !!}
    {{-- {!! Html::script('public/assets/js/common/admin/jquery.dataTables.min.js') !!} --}}
    {{-- {!! Html::script('public/assets/js/common/admin/dataTables.bootstrap4.min.js') !!} --}}
    {!! Html::script('public/assets/js/common/admin/moment.min.js') !!}
    {!! Html::script('public/assets/js/common/admin/bootstrap-datetimepicker.min.js') !!}
    {{-- {!! Html::script('public/assets/co/commonlorbox/js/jquery.colorbox.js') !!} --}}
    {!! Html::script('public/assets/js/common/secure.js') !!}
    ...
    {{-- {!! Html::script('public/assets/js/common/admin/app.js') !!} --}}
    {{-- {!! Html::script('public/assets/js/common/admin/admin.js') !!} --}}
    {!! Html::script('public/backend/js/preview.js') !!}
