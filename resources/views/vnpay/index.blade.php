...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('public/vnpay_php/assets/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL::to('public/vnpay_php/assets/jumbotron-narrow.css') }}">
    <script src="{{ URL::to('public/vnpay_php/assets/jquery-1.11.3.min.js') }}"></script>
</head>
            ...
            <form action="{{ route('Payment') }}" id="create_form" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="order_type" id="order_type" class="form-control">
                        ...
                        <option value="billpayment" checked>Thanh toán hóa đơn</option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="order_id" name="order_id" type="text" readonly
                        value="{{ 'HD_' . strtoupper(substr(md5(microtime()), rand(0, 25), 4)) }}" />
                </div>
                <div class="form-group">
                    <label for="amount">Số tiền</label>
                    <input class="form-control" readonly id="amount" name="amount" type="number"
                        value="{{ $totalPrice }}" />
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="__RequestVerificationToken"
                    value="oA1_oE2bOvpDSS41c7ddcf_eavWdJa8ixsKSd_H33sEey2iipkQWePOHoD7dxTbexL3tl_qiCGRMkwYBSATZDl7sDjCDkGOzntnvyn1CTug1">
                <button type="submit" class="btn btn-primary" id="btnPopup" name="redirect">Thanh toán
                    Post</button>
